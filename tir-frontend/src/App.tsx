...
// // Импортируем через .page файлы
// const HomePage = lazy(() => import('@/pages/index.page').then(module => ({ default: module.Page })))
// const CatalogPage = lazy(() => import('@/pages/catalog/index.page').then(module => ({ default: module.Page })))
// const ProductPage = lazy(() => import('@/pages/product/index.page').then(module => ({ default: module.Page })))
// const ProfilePage = lazy(() => import('@/pages/profile/index.page').then(module => ({ default: module.Page })))
// const AdminPage = lazy(() => import('@/pages/admin/index.page').then(module => ({ default: module.Page })))
// const Constructor3D = lazy(() => import('@/features/constructor/index.page').then(module => ({ default: module.Page })))
